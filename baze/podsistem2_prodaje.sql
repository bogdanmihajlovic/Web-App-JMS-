...
CREATE TABLE `prodaje` (
  ...
  KEY `FK_idArtikal_artikal_idx` (`idArtikal`),
  KEY `FK_idProdavac_korisnik_idx` (`idProdavac`),
  CONSTRAINT `FK_idArtikal_artikal` FOREIGN KEY (`idArtikal`) REFERENCES `artikal` (`idArtikal`),
  CONSTRAINT `FK_idProdavac_korisnik` FOREIGN KEY (`idProdavac`) REFERENCES `korisnik` (`idKorisnik`)
...
INSERT INTO `prodaje` VALUES (1,1,1,1000,0);
...
-- Dump completed on 2023-02-22  3:33:07
